    ...
    return (
      <div className='min-h-screen items-center justify-between w-4/5 mx-auto my-0'>
        ...
        <form action={async () => {
                      ...
                      >
          <button className="flex grow h-[48px] items-center justify-center gap-2 rounded-md bg-gray-50 text-sm font-medium hover:bg-sky-100 hover:text-blue-600 mb-4 md:flex-none md:justify-start p-2 px-3">
              <div>Sign Out</div>
          </button>
        </form>
    </div>
